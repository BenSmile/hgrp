...
@Named(value = "grossesseController")
@SessionScoped
public class GrossesseController extends AbstractController<Grossesse> {
    ...
    public GrossesseController() {
        // Inform the Abstract parent controller of the concrete Grossesse Entity
