...
@Named(value = "hospitalisationController")
@SessionScoped
public class HospitalisationController extends AbstractController<Hospitalisation> {
    ...
    public HospitalisationController() {
        // Inform the Abstract parent controller of the concrete Hospitalisation Entity
