...
@Named(value = "reglesController")
@ViewScoped
public class ReglesController extends AbstractController<Regles> {
    ...
    public ReglesController() {
        // Inform the Abstract parent controller of the concrete Regles Entity
        super(Regles.class);
    }
