...
@Named(value = "donneesObjectivesController")
@SessionScoped
public class DonneesObjectivesController extends AbstractController<DonneesObjectives> {
    ...
    public DonneesObjectivesController() {
        // Inform the Abstract parent controller of the concrete DonneesObjectives Entity
