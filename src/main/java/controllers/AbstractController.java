...
import ejb.LazyEntityDataModel;
...
public abstract class AbstractController<T> implements Serializable {
    ...
    public void save(ActionEvent event) {
        String msg = ResourceBundle.getBundle("resources/Bundle").getString(itemClass.getSimpleName() + "Updated");
    ...
    public void saveNew(ActionEvent event) {
        String msg = ResourceBundle.getBundle("resources/Bundle").getString(itemClass.getSimpleName() + "Created");
      
        persist(PersistAction.CREATE, msg);
        System.out.println("$$$ entity persisted");
        
        if (!isValidationFailed()) {
            System.out.println("validation not failed");
    ...
    public void delete(ActionEvent event) {
        String msg = ResourceBundle.getBundle("resources/Bundle").getString(itemClass.getSimpleName() + "Deleted");
